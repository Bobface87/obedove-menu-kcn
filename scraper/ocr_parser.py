...
def split_menu_headers(text):

    """
    OCR niekedy nalepí nový názov menu
    na koniec predchádzajúceho riadku.
    Napr:
    ... /4,7/ FITMENU - ROAST BEEF

    Rozdelíme to na nový riadok.
    """
